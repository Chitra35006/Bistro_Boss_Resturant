...
const NavBar = () => {
    const navOptions = <>
        <li className="bg-transparent hover:bg-red-700 transition duration-300"><NavLink className="bg-transparent">HOME</NavLink></li>
        ...
        <li className="bg-transparent hover:bg-red-700 transition duration-300"><NavLink className="bg-transparent">OUR MENU</NavLink></li>
