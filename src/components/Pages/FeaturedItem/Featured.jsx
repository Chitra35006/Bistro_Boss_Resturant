    ...
    return (
        <div className='featured-item bg-fixed text-white p-8 my-20'>
           ...
           >
            ...
            <div className="md:flex justify-center items-center pb-20 mx-20 pt-12 px-36 bg-black bg-opacity-40">
                <div>
                ...
                <div className="md:ml-10">
                    ...
                    <button className="btn btn-outline text-red-400 border-0 border-b-4 mt-4">Order Now</button>
                </div>
            </div>
        </div>
    );
